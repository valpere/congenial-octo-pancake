...
/**
 * Main entry point for the Web Page Analyzer application.
 * This class defines the root command and configures subcommands.
 */
@Command(
    name = "web-page-analyzer",
    version = "1.0.0",
    description = "A CLI tool for web page analysis and transformation",
...
class WebPageAnalyzer implements Callable<Integer> {
    ...
    static class ExceptionHandler implements CommandLine.IExecutionExceptionHandler {
        @Override
        int handleExecutionException(Exception ex, CommandLine commandLine, 
