...
class CompareCommand implements Callable<Integer> {
     ...
     */
    private List compareVisual(Document doc1, Document doc2) {
        def differences = []
     ...
     */
    private Map<String, Integer> countElementsByTag(Document doc) {
        def tagCounts = [:]
     ...
     */
    private Map<String, Element> mapElementsById(Elements elements) {
        def result = [:]
     ...
     */
    private List<String> compareElementAttributes(Element e1, Element e2, List<String> attributesToIgnore) {
        def differences = []
